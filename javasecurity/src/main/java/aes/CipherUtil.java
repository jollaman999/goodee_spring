...
class CipherUtil {
    ...
    static String decrypt(String cipher1) {
    ...
    static String decrypt(String cipher1, String key) {
        byte[] plainMsg = new byte[1024];
    ...
    static void encryptFile(String plainFile, String cipherFile, String strkey) {
        try {
            getKey(strkey);
